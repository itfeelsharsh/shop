    ...
    const fetchPaymentMethods = async () => {
      if (user) {
        ...
        if (userDocSnapshot.exists()) {
          ...
          // Pre-fill the card or UPI information if available
    ...
    if (user) {
      ...
      try {
        ...
        if (paymentMethod === 'Card') {
          ...
          // Validate card number (at least 12 digits)
        ...
        // Update the user document with the new payment method
        await updateDoc(userRef, { paymentMethods: paymentData });
        console.log("Payment methods updated successfully.");

        // Redirect to the external URL
        window.location.href = 'https://firebasestorage.googleapis.com/v0/b/cdn-69.appspot.com/o/Files%2Fdgjhdfvjfds.mp4?alt=media&token=0cae86e5-f4f0-40a1-a953-98a4bfa565b3';
      } catch (error) {
